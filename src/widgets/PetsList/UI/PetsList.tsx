...
import { Pets, PetsRegisteredSchema } from "entities/PetsRegistered";
import { PetsRegisteredActions } from "entities/PetsRegistered";
import Loader from "shared/UI/Loader/Loader";
import Pagination from "shared/UI/Pagination/Pagination";
import { PetListItem } from "../PetListItem";

const PetsList: FC<PetsRegisteredSchema> = ({
  result,
  page,
  limit,
  isLoading,
